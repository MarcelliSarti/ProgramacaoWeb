<?php
  ...
  $insert_script = "insert into partidas (codigo, codigo_usuario, modo_jogo, tamanho_tabuleiro, tempo, data, resultado) values (".$codigo.",".$_SESSION['codigo'].",".$modo_jogo.",".$tamanho_tabuleiro.",'".$time."',CURDATE(),".$resultado.")";
