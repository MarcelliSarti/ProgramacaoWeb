    ...
    <div class="main">
      <div class="buttons">
        ...
        <div class="middle">
          ...
          <div class="button active" id="desativarTrapaca">Desativar trapaça</div>
        </div>
      ...
      <div class="cards" id="cards">
        ...
        <div class="card">
          <div class="front face">
            <div class="contour">
              <img src="./img/bandeiras/bra.png" alt="Brasil">
            </div>
          </div>
          <div class="back face">
            <div class="contour">
              <img src="./img/miniLogo.png" alt="icon">
            </div>
          </div>
        </div>
        <div class="card">
